...
INSERT INTO `areas_comunitarias` VALUES (1,'parque para niños','#86'),(3,'Cancha principal','#19'),(4,'Piscina','Area Principal'),(5,'Piscina Infantil','#90'),(6,'Playa','#67'),(7,'voley playa','#78');
...
CREATE TABLE `empresas_guardias` (
  ...
  `personas_empresas_guardias_reservas_id` int unsigned NOT NULL,
  PRIMARY KEY (`empresas_guardias_id`,`personas_empresas_guardias_reservas_id`),
...
INSERT INTO `personas` VALUES (1,'Danna Sofia','Arias Molina','2005-11-14','3168272127','CC',1070590809,'sofiarias@gmail.com','Cr 12 #90-20');
...
--
-- Table structure for table `personas_perfil`
--

DROP TABLE IF EXISTS `personas_perfil`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `personas_perfil` (
  `personas_perfil_id` int unsigned NOT NULL AUTO_INCREMENT,
  `personas_personas_id` int unsigned NOT NULL,
  `perfil_perfil_id` int unsigned NOT NULL,
  PRIMARY KEY (`personas_perfil_id`),
  KEY `fk_personas_perfil_personas1_idx` (`personas_personas_id`),
  KEY `fk_personas_perfil_perfil1_idx` (`perfil_perfil_id`),
  CONSTRAINT `fk_personas_perfil_perfil1` FOREIGN KEY (`perfil_perfil_id`) REFERENCES `perfil` (`perfil_id`),
  CONSTRAINT `fk_personas_perfil_personas1` FOREIGN KEY (`personas_personas_id`) REFERENCES `personas` (`personas_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personas_perfil`
--

LOCK TABLES `personas_perfil` WRITE;
/*!40000 ALTER TABLE `personas_perfil` DISABLE KEYS */;
/*!40000 ALTER TABLE `personas_perfil` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pqrs` (
  ...
  CONSTRAINT `fk_pqrs_personas1` FOREIGN KEY (`personas_personas_id`) REFERENCES `personas` (`personas_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservas` VALUES (1,'2004-03-14','10:10:00','2004-04-15 11:11:00',1,7),(2,'2024-04-23','20:56:00','2024-04-18 16:53:00',1,1),(3,'2024-04-13','20:54:00','2024-04-13 21:55:00',1,5);
...
CREATE TABLE `visitas` (
  `visitas_id` int unsigned NOT NULL AUTO_INCREMENT,
  `visitas_fecha_llegada` date NOT NULL,
  `visitas_fecha_salida` date DEFAULT NULL,
  `personas_personas_id` int unsigned NOT NULL,
  `propiedades_propiedades_id` int unsigned NOT NULL,
  `personas_perfil_personas_perfil_id` int unsigned NOT NULL,
  PRIMARY KEY (`visitas_id`,`propiedades_propiedades_id`,`personas_perfil_personas_perfil_id`),
...
-- Dump completed on 2024-04-16 16:46:02
